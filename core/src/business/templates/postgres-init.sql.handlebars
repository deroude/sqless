...
from PUBLIC;
revoke all on schema information_schema
from PUBLIC;
revoke all on schema pg_catalog
from PUBLIC;
revoke all on all tables in schema public
from PUBLIC;
revoke all on all tables in schema information_schema
from PUBLIC;
revoke all on all tables in schema pg_catalog
from PUBLIC;
